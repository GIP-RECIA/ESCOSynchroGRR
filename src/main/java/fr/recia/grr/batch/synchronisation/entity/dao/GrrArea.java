...
public class GrrArea implements Serializable {
    ...
    @ManyToMany(mappedBy = "grr_j_user_area")
    private Set<GrrUtilisateurs> grr_j_area_user;

    @ManyToMany(mappedBy = "grr_j_useradmin_area")
    private Set<GrrUtilisateurs> grr_j_area_useradmin;

    @ManyToMany(mappedBy = "grr_j_site_area", cascade = CascadeType.ALL)
    private Set<GrrSite> grr_j_area_site;

    @ManyToMany(mappedBy = "grr_j_type_area", cascade = CascadeType.ALL)
     ...
     */
    public GrrArea() {
        grr_j_area_useradmin = new HashSet<>();
        grr_j_area_user = new HashSet<>();
        grr_j_area_site = new HashSet<>();
        grrAreaPeriodes = new HashSet<>();
        grrOverloads = new HashSet<>();
        grr_j_area_typeArea = new HashSet<>();
    }
    ...
    public Set<GrrUtilisateurs> getGrr_j_area_user() {
        return grr_j_area_user;
    }

    public void setGrr_j_area_user(Set<GrrUtilisateurs> grr_j_area_user) {
        this.grr_j_area_user = grr_j_area_user;
    }

    public Set<GrrUtilisateurs> getGrr_j_area_useradmin() {
        return grr_j_area_useradmin;
    }

    public void setGrr_j_area_useradmin(Set<GrrUtilisateurs> grr_j_area_useradmin) {
        this.grr_j_area_useradmin = grr_j_area_useradmin;
    }

    public Set<GrrSite> getGrr_j_area_site() {
    ...
    public Set<GrrTypeArea> getGrr_j_area_typeArea() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GrrArea)) {
            return false;
        }
        GrrArea assignedRole = (GrrArea) o;
        return Objects.equals(id, assignedRole.getId()) &&
                Objects.equals(areaName, assignedRole.getAreaName());
    }
