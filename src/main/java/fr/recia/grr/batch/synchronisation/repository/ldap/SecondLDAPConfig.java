...
@Configuration
@EnableLdapRepositories(basePackages = "fr.recia.grr.batch.synchronisation.repository.ldap.personne", ldapTemplateRef = "ldapTemplate2")
public class SecondLDAPConfig {

    @Value("${spring.ldap.urls}")
    private String ldapUrls;

    @Value("${spring.ldap.base_personnes}")
