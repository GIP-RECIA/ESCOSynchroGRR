...
delete from grr_repeat;
delete from grr_entry_moderate;
...
INSERT INTO grr_utilisateurs (login, nom, prenom, password, email, statut, etat, default_site, default_area, default_etablissement, default_room, default_style, default_list_type, default_language, source) VALUES('F0000aaa', 'F0000aaa', 'F0000aaa', '', 'F0000aaa@domaine.fr', 'utilisateur', 'actif', 0, 0, 2, 0, '', '', '', 'ext');
...
INSERT INTO grr_log (`LOGIN`, `START`, `SESSION_ID`, `REMOTE_ADDR`, `USER_AGENT`, `REFERER`, `AUTOCLOSE`, `END`) VALUES ('F080D5PE',  '2010-11-09 16:54:31', '1', '192.168.1.92', 'Windows 7 Firefox 63.0', 'https://lycees.netocentre.fr/', null, '2010-11-09 16:54:31');
INSERT INTO grr_log (`LOGIN`, `START`, `SESSION_ID`, `REMOTE_ADDR`, `USER_AGENT`, `REFERER`, `AUTOCLOSE`, `END`) VALUES ('F080d4pe',  '2030-11-09 16:54:31', '2', '192.168.1.92', 'Windows 7 Firefox 63.0', 'https://lycees.netocentre.fr/', null, '2030-11-09 16:54:31');
INSERT INTO grr_log (`LOGIN`, `START`, `SESSION_ID`, `REMOTE_ADDR`, `USER_AGENT`, `REFERER`, `AUTOCLOSE`, `END`) VALUES ('F0000aaa',  '2030-11-09 16:54:31', '3', '192.168.1.92', 'Windows 7 Firefox 63.0', 'https://lycees.netocentre.fr/', null, '2030-11-09 16:54:31');
...
INSERT INTO grr_entry (`id`,`start_time`, `end_time`, `entry_type`, `repeat_id`, `room_id`, `timestamp`, `create_by`, `beneficiaire_ext`, `beneficiaire`, `name`, `type`, `description`, `statut_entry`, `option_reservation`, `overload_desc`, `moderate`, `jours`, `clef`, `courrier`) VALUES ('2',1839824092, 1039824992, 0, 1, 1, '2010-02-11 15:45:21', 'TEST', '', 'TEST', 'test1', 'A', '', '-', -1, '', 0, 0, 0, 0);
INSERT INTO grr_entry (`id`,`start_time`, `end_time`, `entry_type`, `repeat_id`, `room_id`, `timestamp`, `create_by`, `beneficiaire_ext`, `beneficiaire`, `name`, `type`, `description`, `statut_entry`, `option_reservation`, `overload_desc`, `moderate`, `jours`, `clef`, `courrier`) VALUES ('3',1839824092, 2147483647, 0, 0, 1, '2010-02-11 15:45:21', 'TEST', '', 'TEST', 'test1', 'A', '', '-', -1, '', 0, 0, 0, 0);
INSERT INTO grr_repeat (`id`,`start_time`, `end_time`, `rep_type`, `end_date`, `rep_opt`, `room_id`, `timestamp`, `create_by`, `beneficiaire_ext`, `beneficiaire`, `name`, `type`, `description`, `rep_num_weeks`, `overload_desc`, `jours`, `courrier`) VALUES ('1',1249897200, 1049899000, 2, 2147483647, 0100000, 1, '2010-02-11 15:45:21', 'TEST', '', 'TEST', 'test1', 1, '-', 1, '', 0, 0);
INSERT INTO grr_repeat (`id`,`start_time`, `end_time`, `rep_type`, `end_date`, `rep_opt`, `room_id`, `timestamp`, `create_by`, `beneficiaire_ext`, `beneficiaire`, `name`, `type`, `description`, `rep_num_weeks`, `overload_desc`, `jours`, `courrier`) VALUES ('2',1249897200, 1049899000, 2, 1049899000, 0100000, 1, '2010-02-11 15:45:21', 'TEST', '', 'TEST', 'test1', 1, '-', 1, '', 0, 0);
INSERT INTO grr_entry_moderate (`id`, `login_moderateur`, `motivation_moderation`, `start_time`, `end_time`, `entry_type`, `repeat_id`, `room_id`, `timestamp`, `create_by`, `beneficiaire_ext`, `beneficiaire`, `name`, `type`, `description`, `statut_entry`, `option_reservation`, `overload_desc`, `moderate`) VALUES ('1', 'a', 'a', 1249897200, 1049899000, 0, 0, 1, '2010-02-11 15:45:21', 'TEST', '', 'TEST', 'test1', 'A', '', '-', -1, '', 0);
INSERT INTO grr_entry_moderate (`id`, `login_moderateur`, `motivation_moderation`, `start_time`, `end_time`, `entry_type`, `repeat_id`, `room_id`, `timestamp`, `create_by`, `beneficiaire_ext`, `beneficiaire`, `name`, `type`, `description`, `statut_entry`, `option_reservation`, `overload_desc`, `moderate`) VALUES ('2', 'a', 'a', 1249897200, 2147483647, 0, 0, 1, '2010-02-11 15:45:21', 'TEST', '', 'TEST', 'test1', 'A', '', '-', -1, '', 0);
